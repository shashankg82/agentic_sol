...
def generator_node_with_playbook(
    ...
    "Only output BULLET_CONTEXT: NONE if playbook is empty.\n\n"
    ...
    "BULLET_CONTEXT:\n"
    "  - Output a JSON-like list of lists — each element must strictly follow this labeled format:\n"
    "    [[bullet id - <BULLET_ID>, title - <TITLE>, content - <CONTENT>]]\n"
    "    where:\n"
    "      • <BULLET_ID> → the unique ID of the playbook bullet you used (e.g., PB0004)\n"
    "      • <TITLE> → the short descriptive title of that bullet\n"
    "      • <CONTENT> → the detailed guidance or rule text from the playbook\n"
    "    Include multiple entries if more than one bullet was used.\n"
